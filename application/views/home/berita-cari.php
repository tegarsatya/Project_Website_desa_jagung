  ...
  <div class="container">
    ...
    <div class="col-md-12 text-center" style="margin-bottom:25px;">
      <form class="form-inline" action="<?= base_url('berita/cari') ?>" method="get">
        <input type="text" class="form-control" name="cariberita" value="<?= $cari ?>" style="width:75%;float:left;border-radius:25px">
        <button type="submit" class="btn btn-primary" style="margin:0 0 0 5px; float:left; width:22%; border-radius:25px">Cari</button>
      </form>
      </div>
      <h3 class="text-center">Berita dengan judul : <strong><?= $cari ?></strong> </h3>
